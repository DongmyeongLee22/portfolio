                ...
                projects: [
                    {
                        ...
                        content: '각자 프로젝트를 제작하는 온라인 스터디를 통해 제작하고 있는 프로젝트입니다. Spring Security OAuth2를 이용하여 권한 서버, 리소스 서버를 구축하였고' +
                            'JWT 토큰을 통해 인증을 구현하였습니다. 현재 AWS에 서버가 구축되어 있으 클라이언트는 서버는 Netlify에 배포되어 있습니다.' +
                            ' Travis CI와 CodeDeploy를 통해 무중단 배포가 가능하도록 구현하였습니다. 현재는 게시판을 구현하여 Toast UI Editor를 통해 제가 공부한 게시글을 올리고 있습니다.' +
                            ' 댓글은 계층형으로 구현해 보았고 JPA를 사용하여 재귀를 활용하여 구현하였습니다. 그밖에 검색, 정렬등 기본적인 게시판 기능을 구현하였습니다. ',
                    ...
                    },
                    {
                        ...
                        content: `REST에 대한 이해와 REST의 구현 원칙을 지켜 RESTful API를 설계해본 프로젝트입니다.
                                  ...
                                  수행하였습니다. 문서화는 테스트 코드 작성을 통해 이루어지므로 테스트에 대한 중요성을 깨달았습니다. Mock 객체를 통해 Web
                    ...
                    },
                    {
                        ...
                        프로젝트 세부사항은 따로 아래의 상세페이지에 정리하였습니다.`,
